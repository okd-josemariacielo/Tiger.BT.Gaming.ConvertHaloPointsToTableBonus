namespace Tiger.BT.Gaming.ConvertHaloPointsToTableBonus.Map {
    ...
    [Microsoft.XLANGs.BaseTypes.SchemaReference(@"Tiger.BT.Gaming.ConvertHaloPointsToTableBonus.Schema.Halo1.HaloPointAdjustmentRequest1", typeof(global::Tiger.BT.Gaming.ConvertHaloPointsToTableBonus.Schema.Halo1.HaloPointAdjustmentRequest1))]
    ...
    public sealed class Trfm_HaloS2S_Service_Request : global::Microsoft.XLANGs.BaseTypes.TransformBase {
        
        private const string _strMap = @"<?xml version=""1.0"" encoding=""UTF-16""?>
<xsl:stylesheet xmlns:xsl=""http://www.w3.org/1999/XSL/Transform"" xmlns:msxsl=""urn:schemas-microsoft-com:xslt"" xmlns:var=""http://schemas.microsoft.com/BizTalk/2003/var"" exclude-result-prefixes=""msxsl var s0"" version=""1.0"" xmlns:ns0=""http://www.gamingstandards.com/s2s/wsdl/v1.1/S2SMessageService.wsdl"" xmlns:s0=""http://www.gamingstandards.com/s2s/schemas/v1.2.6/"">
  <xsl:output omit-xml-declaration=""yes"" method=""xml"" version=""1.0"" />
  <xsl:template match=""/"">
    <xsl:apply-templates select=""/s0:s2sMessage"" />
  </xsl:template>
  <xsl:template match=""/s0:s2sMessage"">
    <ns0:s2sRequest>
 ...
 <xsl:apply-templates select=""@*|node()"" />
        ...
        private const string _strSrcSchemasList0 = @"Tiger.BT.Gaming.ConvertHaloPointsToTableBonus.Schema.Halo1.HaloPointAdjustmentRequest1";
        
        private const global::Tiger.BT.Gaming.ConvertHaloPointsToTableBonus.Schema.Halo1.HaloPointAdjustmentRequest1 _srcSchemaTypeReference0 = null;
        ...
        public override string[] SourceSchemas {
            get {
                ...
                _SrcSchemas[0] = @"Tiger.BT.Gaming.ConvertHaloPointsToTableBonus.Schema.Halo1.HaloPointAdjustmentRequest1";
                return _SrcSchemas;
            }
        }
