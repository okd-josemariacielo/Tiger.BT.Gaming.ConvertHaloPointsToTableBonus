namespace Tiger.BT.Gaming.ConvertHaloPointsToTableBonus.Map {
    ...
    public sealed class FCMSReqToHAloReq : global::Microsoft.XLANGs.BaseTypes.TransformBase {
      ...
      <ns0:s2sBody>
        <pli:playerInfo>
          ...
          <pli:getPlayerBalances>
            ...
            <xsl:variable name=""var:v12"" select=""userCSharp:GetIncludeAllBoolValue()"" />
...
public bool GetIncludeAllBoolValue()
{
            return true;
}
