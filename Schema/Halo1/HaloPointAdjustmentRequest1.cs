namespace Tiger.BT.Gaming.ConvertHaloPointsToTableBonus.Schema.Halo {
    ...
    [Schema(@"http://www.gamingstandards.com/s2s/schemas/v1.2.6.1/",@"s2sMessage")]
    [System.SerializableAttribute()]
    [SchemaRoots(new string[] {@"s2sMessage"})]
    public sealed class BallyPointAdjustmentRequest : Microsoft.XLANGs.BaseTypes.SchemaBase {
...
<xs:schema xmlns:b=""http://schemas.microsoft.com/BizTalk/2003"" xmlns:s2s=""http://www.gamingstandards.com/s2s/schemas/v1.2.6.1/"" elementFormDefault=""qualified"" targetNamespace=""http://www.gamingstandards.com/s2s/schemas/v1.2.6.1/"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element name=""s2sMessage"">
    <xs:complexType>
      <xs:sequence>
          ...
          <xs:complexType>
            <xs:sequence>
              <xs:element name=""WAT"">
                <xs:complexType>
                  <xs:sequence>
                    <xs:element name=""requestTransfer"">
                      <xs:complexType>
                  ...
                  <xs:attribute form=""qualified"" name=""transDateTime"" type=""xs:dateTime"" use=""required"" />
                  ...
                  <xs:attribute form=""qualified"" name=""gameDate"" type=""xs:dateTime"" use=""required"" />
        ...
        public BallyPointAdjustmentRequest() {
        }
